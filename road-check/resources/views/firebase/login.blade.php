            ...
            <div class="col-md-6 col-lg-5">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted mb-4">Accédez à votre espace en toute simplicité.</p>
                        ...
                        <form method="POST" action="{{ route('login.submit') }}" class="mt-2">
                            @csrf
                            <div class="mb-3">
                        ...
                        <div class="text-center mt-3">
                            <small class="text-muted">Pas de compte ? <a href="{{ route('register.form') }}">Inscrivez-vous</a></small>
                        </div>
                    </div>
                </div>
            </div>
